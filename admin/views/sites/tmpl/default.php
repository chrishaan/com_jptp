...
JToolBarHelper::title(JText::_( 'Manage Sites' ), 'generic.png');
...
<table class="adminlist">
  <thead>
    <tr>
      ...
      <th class="title"><?php echo JHTML::_('grid.sort', 'Address', 'address', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
        <th class="title"><?php echo JHTML::_('grid.sort', 'City', 'city', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
        <th class="title"><?php echo JHTML::_('grid.sort', 'State', 'state', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>        
  ...
  for ($i=0, $n=count( $this->rows ); $i < $n; $i++)
  {
	...
	$link = JFilterOutput::ampReplace( 'index.php?option=' . $option . '&controller=sites&task=edit&cid[]='. $row->id );
    ?>

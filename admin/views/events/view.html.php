...
/**
 * View class for the events list
 *
 * @package Joomla
 * @subpackage JPTP
 * @since
...
class JptpViewEvents extends JView
{	
    function display($tpl = null)
    {
        ...
        $filter_state = $mainframe->getUserStateFromRequest( $option.'events.filter_state', 'filter_state', 	'All', 'word' );
        ...
        $filters[] = JHTML::_('select.option', '2', JText::_( 'Trainers' ) );

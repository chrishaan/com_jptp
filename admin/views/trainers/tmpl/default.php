...
JToolBarHelper::title(JText::_( 'Manage Trainers' ), 'generic.png');
...
<table class="adminlist">
  <thead>
    <tr>
      ...
      <th class="title"><?php echo JHTML::_('grid.sort', 'First Name', 'first_name', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
        <th class="title"><?php echo JHTML::_('grid.sort', 'Organization', 'organization', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
  ...
  for ($i=0, $n=count( $this->rows ); $i < $n; $i++)
  {
	...
	$link = JFilterOutput::ampReplace( 'index.php?option=' . $option . '&controller=trainers&task=edit&cid[]='. $row->id );
    ?>

...
/**
 * View class for the audiences list
 *
 * @package Joomla
 * @subpackage JPTP
 * @since
...
class JptpViewAudiences extends JView
{	
    function display($tpl = null)
    {
        ...
        $filter_order = $mainframe->getUserStateFromRequest( $option.'audiences.filter_order', 'filter_order', 'title', 'cmd' );

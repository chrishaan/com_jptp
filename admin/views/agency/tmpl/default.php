...
<fieldset class="adminform">
    ...
    <tr>
        ...
        <td>
            <textarea name="services" id="services" style="width: 300px; height: 75px;"><?php echo $this->row->services; ?></textarea>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <textarea name="funding_sources" id="funding_sources" style="width: 300px; height: 75px;"><?php echo $this->row->funding_sources; ?></textarea>
        </td>
    </tr>
    <tr>
        <td width="200" align="right" class="key">Primary Clientele and Referral Sources</td>
        <td>
            <textarea name="primary_clientele" id="primary_clientele" style="width: 300px; height: 75px;"><?php echo $this->row->primary_clientele; ?></textarea>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <textarea name="staff_education" id="staff_education" style="width: 300px; height: 75px;"><?php echo $this->row->staff_education; ?></textarea>
        </td>
    </tr>
    <tr>
        <td width="200" align="right" class="key">Networking Agencies</td>
        <td>
            <textarea name="networking_agencies" id="networking_agencies" style="width: 300px; height: 75px;"><?php echo $this->row->networking_agencies; ?></textarea>        </td>
    </tr>
    <tr>
        <td width="200" align="right" class="key">Comments</td>
        <td>
            <textarea name="comments" id="comments" style="width: 300px; height: 75px;"><?php echo $this->row->comments; ?></textarea>
        </td>
    </tr>
    <tr>
    ...
    <input type="hidden" name="approved_memory" value="<?php echo $this->row->published; ?>" />
